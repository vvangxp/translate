export default {
  ...
  "cautions": {
    ...
    "no_domain": {
      "title": "添加域名",
      "message": "您可以将一个或多个个人域名连接到您的商店，您的网站将安装在您的域名上。这个过程既快速又简单。"
    },
    "domain_not_approved": {
      "title": "域名验证",
      "message": "您的域名 {domain} 尚未经过验证。检查 DNS 设置并确认域名。"
    },
    "no_currency": {
      "title": "添加货币",
    ...
    "no_primary_domain": {
      "title": "主域名",
      "message": "请选择一个域名作为您的主域名。通过单击域名旁边的星号按钮，您可以选择该域作为您商店的主域名，这对搜索引擎至关重要。请注意，您的商店仍可通过所有活动域名访问。"
    },
    "shop_complete": {
      "title": "完整信息",
      "action": "店铺设置",
